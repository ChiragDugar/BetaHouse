...
export default class AdminDashboard4 extends Component {

    constructor(props){
        super(props);
        this.state = {
            propertyType:"studentAccom",
            propertyList:[],
            value:"",
            suggestions:[],
            featuredList:[],
    ...
    render() {
        ...
        return (
            <div>
                <div className="row">
                    <h3 className="col admin-dashboard-add-city-heading">Featured properties for Student Accomodation</h3>
                </div>
                <div className="row">
